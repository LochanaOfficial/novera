...
export const pricingCards = [
    {
      ...
      features: ['3 Sub accounts', '2 Team members', 'Unlimited pipelines', 'Unlimited Storage'],
      priceId: '',
    },
    {
      ...
      duration: 'month',
      highlight: 'Key features',
      features: ['Rebilling', '24/7 Support team', 'Unlimited Sub accounts', 'Full Power'],
    ...
    },
    {
      ...
      features: ['Unlimited Sub accounts', 'Unlimited Team members', 'User Management', 'Smooth Management' ],
