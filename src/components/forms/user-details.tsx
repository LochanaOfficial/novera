...
import { AuthUserWithAgencySidebarOptionSubAccounts, UserWithPermitionsAndSubAccounts } from "@/lib/types";
import { useModal } from "@/providers/modal-provider";
import { SubAccount, User } from "@prisma/client"
import { useEffect, useState } from "react"
import { useToast } from "../ui/use-toast";
import { useRouter } from "next/navigation";
import { changeUserPermissions, getAuthUserDetails, getUserPermissions, saveActivityLoginNotification, updateUser } from "@/lib/queries";
import { z } from "zod";
...
const UserDetails = ({
    ...
    const [subAccountPermissions, setSubAccountsPermissions] = useState<UserWithPermitionsAndSubAccounts | null>(null);

    const { data, setOpen } = useModal();
    const [roleState, setRoleState] = useState("");
    const [loadingPermissions, setLoadingPermissions] = useState(false);
    const [authUserData, setAuthUserData] = useState<AuthUserWithAgencySidebarOptionSubAccounts | null>(null)
