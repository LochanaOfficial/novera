...
import { ChevronLeft, Gem, Handshake, LogOut, Moon, Settings, Sun, UserRound } from "lucide-react";
...
import RoundedAuthAvatar from "@/app/components/RoundedAuthAvatar";


interface RoundedAuthUserMenuProps {
  currentUser?: User | null;
}

const RoundedAuthUserMenu: React.FC<RoundedAuthUserMenuProps> = ({
    currentUser,
}) => {
  ...
  return (
    <div className="relative">
        ...
        <div
                onClick={toggleOpen}
                className="p-4 md:py-1 hidden md:flex md:px-1 md:pl-2 border-none border-neutral-200 
                            flex-row items-center gap-3 rounded-full cursor-pointer
                           hover:shadow-md transition dark:border-neutral-600"
            >
                <div className="hidden md:block">
                    <RoundedAuthAvatar width={36} height={36} src={user?.imageUrl} />
                </div>
        </div>
        ...
        <SheetTrigger className="md:hidden hover:opacity-75 transition bg-background">
            <div
                    onClick={() => {}}
                    className="p-4 md:py-1 md:hidden flex md:px-1 md:pl-2 border-[0px] border-neutral-200 
                                flex-row items-center gap-3 rounded-full cursor-pointer
                            hover:shadow-md transition dark:border-neutral-600"
                >
                    <div>
        ...
        <SheetClose>
            <SheetContent side="right" className="p-0 bg-white w-[300px] dark:bg-neutral-950">
               <div className="p-4">
                 <Avatar src={user?.imageUrl} />
               </div>
        ...
        {isOpen && (
            <div ref={ref} className="absolute rounded-xl dark:border dark:border-slate-900 shadow-md w-[40vw] md:w-[200px] bg-white dark:bg-background overflow-hidden right-0 top-12 text-sm">
...
export default RoundedAuthUserMenu;